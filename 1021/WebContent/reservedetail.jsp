...
<tr>
	<td colspan="2" align="center">
		<input type="button" value="수정" onclick="location.href='reserveupdate.jsp?seq=<%-- <%=dto.getSeq() %> --%>'">
		<input type="button" value="삭제" onclick="location.href='reservedel.jsp?seq=<%-- <%=dto.getSeq() %> --%>'">
	</td>
</tr>
