	...
	<section>
		<div class="rad-body-wrapper rad-nav-min">
			<div class="container-fluid">
				...
				<form action="PdsControl" method="post">
					<input type="hidden" name="command" value="ad_notice_answer">
					<div align="center" style="margin-bottom: 100px">
						...
						<table border="1" bgcolor="pink">
							...
							<tr>
								<td class="t">아이디</td>
								<td><%=user.getId()%> <input type="hidden" name="seq"
									value="<%=seq%>"> <input type="hidden" name="id"
									value="<%=user.getId()%>"></td>
							</tr>
