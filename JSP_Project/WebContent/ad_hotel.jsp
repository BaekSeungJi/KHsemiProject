		...
		<div class="rad-body-wrapper rad-nav-min">
			<div class="container-fluid">
				...
				<header class="rad-page-title">
					<span><%=hotelname%> </span> <small><a
						href="HotelControl?command=ad_GohotelUpdate&hotelname=<%=hotelname%>">
							정보 수정하기</a></small>
					...
					<table class="_tablee">
						...
						<%
							...
							String pp = String.format(
									"<a href='%s?command=%s&year=%d&month=%d&hotelname=%s'>" + "<img src='image/left.gif'></a>",
									"HotelControl", "ad_hotel", year - 1, month, hotelname);

							// <
							String p = String.format(
									"<a href='%s?command=%s&year=%d&month=%d&hotelname=%s'>" + "<img src='image/prec.gif'></a>",
									"HotelControl", "ad_hotel", year, month - 1, hotelname, "ad_hotel");

							// >
							String n = String.format(
									"<a href='%s?command=%s&year=%d&month=%d&hotelname=%s'>" + "<img src='image/next.gif'></a>",
									"HotelControl", "ad_hotel", year, month + 1, hotelname, "ad_hotel");

							// >>
							String nn = String.format(
									"<a href='%s?command=%s&year=%d&month=%d&hotelname=%s'>" + "<img src='image/last.gif'></a>",
						...
						<tr height="100" align="left" valign="top" class="_t">
							...
							%>
							<td><%=util.callist(year, month, i, hotelname)%> <%=util.makeTable(year, month, i, list)%>
							</td>
							<%
