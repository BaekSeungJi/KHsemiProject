			...
			<ul>
				<li><a
					...
					class="inbox"> <i class="fas fa-user-alt"> <span
							class="icon-bg rad-bg-success"></span>
					</i> <span class="rad-sidebar-item">회원 관리</span>
				</a></li>

				<li><a
					href="HotelControl?command=ad_hotel&hotelname=<%=hotelname%>">
						<i class="fas fa-hotel"> <span class="icon-bg rad-bg-danger"></span>
					</i> <span class="rad-sidebar-item">호텔 관리</span>
				</a></li>
				<li><a
					href="HotelControl?command=ad_chart&hotelname=<%=hotelname%>"
					class="snooz"><i class="fas fa-chart-pie"><span
							class="icon-bg rad-bg-primary"></span></i><span
		...
		<div class="rad-body-wrapper rad-nav-min">
			<div class="container-fluid">
				...
				<header class="rad-page-title">
					<span> <%=mem.getName()%> 님 환영합니다
					</span> <small class="md-txt"><%=hotelname%> </small>
				</header>
				...
				<div class="row">
					<div class="col-lg-3 col-xs-6">
						<div class="rad-info-box rad-txt-success">
							<i class="fas fa-user-alt rad-info-box_i"></i> <a
								href="MemberControl?command=memberGo&id=<%=mem.getId()%>">
								<span class="heading">회원 관리</span> <span class="value"><span><i
					...
					<div class="col-lg-3 col-xs-6">
						<div class="rad-info-box rad-txt-danger">
							<i class="fas fa-hotel rad-info-box_i"></i> <a
								href="HotelControl?command=ad_hotel&hotelname=<%=hotelname%>">
								<span class="heading">호텔 관리</span> <span class="value"><span><i
										class="fas fa-arrow-alt-circle-right"></i></span></span>
							</a>
						</div>
					</div>
					<div class="col-lg-3 col-xs-6">
						<div class="rad-info-box rad-txt-primary">
							<i class="fas fa-chart-pie rad-info-box_i"></i> <a
								href="HotelControl?command=ad_chart&hotelname=<%=hotelname%>">
								<span class="heading">매출 관리</span> <span class="value"><span><i
										class="fas fa-arrow-alt-circle-right"></i></span></span>
							</a>
						</div>
					</div>
					<div class="col-lg-3 col-xs-6">
						<div class="rad-info-box rad-bg-warning">
							<i class="fas fa-list-ul rad-info-box_i"></i> <a
								href="PdsControl?command=ad_noticeGo"> <span class="heading">공지사항</span>
								<span class="value"><span><i
										class="fas fa-arrow-alt-circle-right"></i></span></span>
							</a>
						</div>
					</div>
						...
						<div class="panel-body">
							...
							<div>
								<div style="float: left; padding-right: 40px">
									<img alt="" src="hotelImage/<%=hoteldto.getImage()%>"
									...
									<form action="MemberControl">
										<table>
											...
											<tr height="40">
												...
												<td><input type="password" value=<%=mem.getPwd()%>
													name="pw"></td>
											</tr>
											...
											<tr height="40">
												...
												<td><input type="text" value=<%=mem.getName()%>
													name="name"></td>
											</tr>

											<tr height="40">
												<td>이메일</td>
												<td><input type="text" value=<%=mem.getEmail()%>
													name="email"></td>
											</tr>

											<tr height="120">
												<td>전화번호</td>
												<td><input type="text" value=<%=mem.getPhone()%>
													name="phone"></td>
											</tr>
	...
	<script type="text/javascript">
		$(".fa-chevron-down").on(
				...
				function() {
					...
					$ele.siblings('.panel-body').toggleClass("rad-collapse",
							function() {
								setTimeout(function() {
									initializeCharts();
								}, 200);
