			...
			<table border="1">
				...
				<tr>
					<td>아이디<input type="hidden" name="seq"
						value="<%=reservedto.getSeq()%>">
					</td>
					<td><input type="text" name="id"
						value="<%=reservedto.getId()%>" readonly="readonly"></td>
				</tr>

				<tr>
					<td>제목</td>
					<td><input type="text" size="60" name="title"
						value="<%=reservedto.getHotelname()%>"></td>
				</tr>
				...
				<tr>
					<td>내용</td>
					<td><textarea rows="20" cols="60" name="content"><%=reservedto.getRequest()%> </textarea>
					</td>
				</tr>
