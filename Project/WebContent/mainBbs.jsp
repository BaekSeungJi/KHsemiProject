	...
	$(document)
			.ready(
					function() {
						...
						function addList(SEQ, ID, HOTELNAME, REGION, MAXPEOPLE,
								PRICE, HOTELPHONE, DEL, READCOUNT, IMAGE) {
								...
								$("#hotelListTable")
										.append(
												'<tr>'
														...
														+ '<img alt="" src="'
														+ IMAGE
														+ '" width="100%" height="120px" style="margin-top: 40px">'
														+ '</td>' + '</tr>');
								// 1 == 삭제 
							} else if (DEL == 1) {
								$("#hotelListTable")
...
<body class="homepage">
 ...
 %>
				...
				<ul>
					<li class="current_page_item"><a href="index.jsp">Homepage</a></li>
					<li><a href="MemberControl?command=ad_admin">관리자 모드</a></li>
					<li><a href="logout.jsp">로그아웃</a></li>
				</ul>
				<%
					}
	...
	<div id="wrapper" class="container">
		...
		<div id="page" class="row">
			...
			<div id="content" class="8u skel-cell-important">
				...
				<p id="mainMap">
					<a href="#"><img src="./css/images/pics02.jpg" alt=""></a>
				</p>
			...
			<div id="sidebar" class="4u">
				...
				<div id="sidebox">
					...
					<ul class="style2">
						<li>
							<p>
								지역 : <input type="text" value="<%=keyword%>" id="searchText"
									size="25px">
							</p>
						</li>
						<li>
							<p>가격 :
							<div id="slider1" style="width: 150px; margin-left: 50px;">
								</p>
								<p id="opa"></p>
						</li>
						<li>
							<p>
								인원 : <select id="sel_people" style="margin-left: 10px;">
						...
						<li>
							<p>
								날짜 : <input type="text" class="date" id="date1"
									placeholder="체크인" size="8px">~ <input type="text"
									class="date" id="date2" placeholder="체크아웃" size="8px">
							</p>
						</li>
					</ul>
					<p>
						<a href="#" class="button" id="btn_search"><span>Search
								More</span></a>
					</p>
					</section>
				</div>
	...
	<div id="copyright">
		<div class="container">
			Design by <a href="http://www.iei.or.kr/main/main.kh" target="_blank">KH
				CLASS_3 semi project 6조</a>
		</div>
	</div>
