	...
	<div align="center">
		...
		<form action="reservewriteAf.jsp" method="post">
			...
			<table border="1">
				...
				<tr>
					<td>아이디</td>
					<td><%=memdto.getId()%> <input type="hidden" name="id"
						value="<%=memdto.getId()%>"></td>
				</tr>

				<tr>
					<td>호텔이름</td>
					<td><input type="text" size="60" name="hotelname" value="호텔이름">
					</td>
				</tr>
				...
				<tr>
					...
					<td><select name="year1">
							...
							%>
					</select>일 <input type="text" value="~" size="4" readonly="readonly">
				...
				<tr>
					<td>요청사항</td>
					<td><textarea rows="20" cols="60" name="request1"></textarea>
					</td>
				</tr>
