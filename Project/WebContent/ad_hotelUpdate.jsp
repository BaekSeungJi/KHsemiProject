			...
			<div class="col-xs-12 col-md-6">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">호텔 정보<ul class="rad-panel-action">
							...
							호텔이름 </td><td><input type="text" value="<%=dto.getHotelname()%>" readonly="readonly" name="hotelname"></td>
								...
								<tr height="40">
								<td>최대인원 </td><td><input type="text" value="<%=dto.getMaxpeople() %>" name="maxpeople"></td>
							</tr>
							
							<tr height="40" >
								<td>가격  </td><td><input type="text" value="<%=dto.getPrice() %>" name="price"></td>
							</tr>
							
							<tr height="40">
								<td>전화번호  </td><td><input type="text" value="<%=dto.getHotelphone() %>" name="hotelphone"></td>
							</tr>
							...
							<tr height="10">
							<td colspan="2"><textarea rows="7" cols=30" name="description"><%=dto.getDescription() %></textarea></td>
							</tr>
							<tr height="10">
