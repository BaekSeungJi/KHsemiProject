				...
				<form action="ReserveControl" method="post">
					...
					<div align="center" style="margin-bottom: 100px">
						...
						<table border="1" bgcolor="pink">
							...
							<tr>
								<td class="t">아이디</td>
								<td><%=id%> <input type="hidden" name="command"
									value=ad_reserveUpdate> <input type="hidden" name="id"
									value="<%=id%>"> <input type="hidden" name="seq"
									value="<%=seq%>"></td>
							</tr>

							<tr>
								<td class="t">체크인</td>
								<td><input type="text" name="checkin" size="50"></td>
							</tr>

							<tr>
								<td class="t">체크아웃</td>
								<td><input type="text" name="checkout" size="50">
								</td>
							</tr>
							<tr>
								<td class="t">요청사항</td>
								<td><textarea rows="20" cols="50" name="request"></textarea>
								</td>
							</tr>
