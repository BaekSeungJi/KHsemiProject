...
<body>
	...
	<aside>
		<nav class="rad-sidebar rad-nav-min">
			<ul>
				<li><a href="#" class="inbox"> <i class="fas fa-user-alt"><span
				...
				<li><a href="#" class="snooz"><i class="fas fa-chart-pie"><span
							class="icon-bg rad-bg-primary"></span></i><span
						class="rad-sidebar-item">매출 관리</span></a></li>
				<li><a href="#" class="done"><i class="fas fa-list-ul"><span
							class="icon-bg rad-bg-warning"></span></i><span
		...
		<div class="rad-body-wrapper rad-nav-min">
			<div class="container-fluid">
				...
				<header class="rad-page-title">
					<span>공지사항 </span> <small><%=mem.getName()%> 회원님</small>
				...
				<div align="center">
					...
					<table border="1" style="background-color: white;">
						...
						<tr bgcolor="#FA8072" align="center" height="25">
							...
							<td style="color: white;">다운로드</td>
							<td style="color: white;">조회수</td>
							<td style="color: white;">다운수</td>
 ...
 %>
				...
				<a href="ad_notice_write.jsp">자료 올리기</a> <br>
				<br>
