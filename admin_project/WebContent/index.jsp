			...
			<div class="container-fluid">
				...
				<div class="col-xs-12 col-md-6">
						<div class="panel panel-default">
							...
							<col width="80">
								<tr height="40">
								<td>아이디  </p></td><td><input type="text" value=" yuriv"></td>
							</tr>
							
							
								<tr height="40">
								<td>이름  </p></td><td><input type="text" value=" yuriv"></td>
							</tr>
							
							<tr height="40" >
								<td>이메일  </td><td><input type="text" value=" yuriv"></td>
							</tr>
							
							<tr height="120">
								<td>전화번호  </td><td><input type="text" value=" yuriv"></td>
							</tr>
							
							<tr height="10">
							<td></td>	<td align="right"><i class="fas fa-wrench"></i></td>
							</tr>
